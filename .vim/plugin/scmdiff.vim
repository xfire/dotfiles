...
map <C-d> :call <SID>SCMDiff()<CR><C-L>
...
function! s:SCMDiff(...)
    ...
    highlight DiffAdd ctermbg=NONE ctermfg=DarkGreen cterm=bold
    highlight DiffChange ctermbg=NONE ctermfg=DarkGreen cterm=bold
    highlight DiffText ctermbg=NONE ctermfg=DarkGreen cterm=bold,underline
    highlight DiffDelete ctermbg=NONE ctermfg=white cterm=bold
